...
namespace myFirstServer.SampleController
{
    ...
    public class SampleController : ControllerBase
    {
        ...
        private static readonly List<int> s_sample = new() { 11 };
        ...
        [HttpDelete("/sample")]
        public ContentResult DeleteSample([FromBody] int sample)
        {
        ...
        [HttpPut("/sample")]
        public ContentResult PutSample([FromBody] int sample)
        {
            s_sample.Add(sample);
            string json = JsonSerializer.Serialize(s_sample);
