...
namespace School.DataInfrastructure
{
    public class SqlRepository : IRepository
    {
        ...
        public IEnumerable<Teacher> GetAllTeachers()
        {
            ...
            using SqlConnection connection = new SqlConnection(this._connctionString);
            connection.Open();
        ...
        public void CreateNewTeacher(Teacher NewTeacher)
        {
            ...
            string cmdText = @"INSERT INTO SchoolTeacher (Name)
            VALUES 
            ({@name});"; 
            ...
            while(reader.Read())
            {
                Teacher tmpTeacher = new Teacher(reader.Get(0), reader.GetString(1));
            }
